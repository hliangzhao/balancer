			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/hliangzhao/balancer/pkg/apis/balancer/v1alpha1.BalancerSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/hliangzhao/balancer/pkg/apis/balancer/v1alpha1.BalancerStatus"),
						},
					},
				},
			},
...
func schema_pkg_apis_balancer_v1alpha1_BalancerSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BalancerSpec defines the desired status of Balancer.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"backends": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/hliangzhao/balancer/pkg/apis/balancer/v1alpha1.BackendSpec"),
									},
								},
							},
						},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/hliangzhao/balancer/pkg/apis/balancer/v1alpha1.BalancerPort"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/hliangzhao/balancer/pkg/apis/balancer/v1alpha1.BackendSpec", "github.com/hliangzhao/balancer/pkg/apis/balancer/v1alpha1.BalancerPort"},
	}
}
...
func schema_pkg_apis_balancer_v1alpha1_BalancerStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BalancerStatus defines the actual status of Balancer.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"activeBackendsNum": {
						SchemaProps: spec.SchemaProps{
